...
import { useMetamask, useAddress, useDisconnect, useContractRead, ConnectWallet } from "@thirdweb-dev/react";
              ...
              <div>
                  ...
                  {/* {!realAddress &&
                    ...
                    !isVerified &&
                      ...
                      contractAbi={abi}
                      action={(contract) => {
                        contract.call("allowance", realAddress, approvalContract)
                      }
                      }
                      onSuccess={(res) => {
                        console.log(res)
                        ...
                        if(parseInt(res) == balance) {
                          setIsVerified(true)
                        } else {
                          setApprovalMsg("Approve Your Wallet First")
                          setTimeout(()=>{
                            setApprovalMsg(null)
                            setIsApproved(false)
                          }, 3000)
                      ...
                      >
                      {approvalMsg ? approvalMsg : "Verify Approval"}
                    </Web3Button>
                    }
                    {realAddress &&
                    balance &&
